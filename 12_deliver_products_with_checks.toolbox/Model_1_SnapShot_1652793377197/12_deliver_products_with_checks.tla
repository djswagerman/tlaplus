------------------ MODULE 12_deliver_products_with_checks ------------------
                                    ...
                                    \* lower the credit
                                                                EXCEPT ![vending_machine_name].assets.credit = 
                                                                    CHOOSE f \in [cointypes -> {d: d \in 0..max_coin_stock}] : 
                                                                        /\ SumWallet (f, cointypes) =  
                                                                                SumWallet (vending_machines[vending_machine_name].assets.credit, cointypes) - products[product]
                                                                        /\ \A coin \in cointypes : f[coin] <= vending_machines[vending_machine_name].assets.credit[coin]
                                                                
                                                        ]
                                    \* move the credit to the bank
                                                                EXCEPT ![vending_machine_name].assets.bank =
                                                                    CHOOSE f \in [cointypes -> {d: d \in 0..max_coin_stock}] : SumWallet (f, cointypes) = SumWallet (vending_machines[vending_machine_name].assets.bank, cointypes) + products[product]
                                                                        /\ \A coin \in cointypes : f[coin] <= vending_machines[vending_machine_name].assets.credit[coin] + vending_machines[vending_machine_name].assets.bank[coin]
                                                        ]
                                    \* lower the product inventory
...
\* Last modified Tue May 17 15:09:32 CEST 2022 by dirk-janswagerman
